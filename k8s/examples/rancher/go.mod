module github.com/SUSE/connect-ng/k8s/examples/rancher

go 1.26.0

require (
	github.com/SUSE/connect-ng/k8s v0.0.0
	k8s.io/api v0.36.1
...
require (
	github.com/SUSE/connect-ng v0.0.0 // indirect
