...
func (u *UnstructuredRegistrationObject) GetSpec() types.ProductRegistrationSpec {
	return u.spec
}

// GetStatus implements types.ProductRegistrationObject
func (u *UnstructuredRegistrationObject) GetStatus() types.ProductRegistrationStatus {
	return u.status
}
...
func (s *UnstructuredSpec) GetMode() types.RegistrationMode {
	mode, _, _ := unstructured.NestedString(s.data, "mode")
	if mode == "" {
		return types.RegistrationModeOnline
	}
	return types.RegistrationMode(mode)
}
...
func (a *UnstructuredAdapter) Get(ctx context.Context, c client.Client, name string) (*unstructured.Unstructured, error) {
	obj := a.New()
...
func (a *UnstructuredAdapter) List(ctx context.Context, c client.Client, opts ...client.ListOption) ([]*unstructured.Unstructured, error) {
